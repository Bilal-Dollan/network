...
urlpatterns = [
    ...
    path("profile/page/likes/counter/<int:post_id>", views.likes_counter, name="profile-likes-counter"),
    path('profile/page/edit/<int:post_id>', views.edit_form, name="edit-profile"),
    path("profile/page/<int:user_id>", views.fetch_profile, name="fetch-profile"),
    path("follow/<int:user_id>", views.follow_user, name="follow-user"),
    path("list/likes/counter/<int:post_id>", views.likes_counter, name="list-likes-counter"),
